...
class RateViewController: UIViewController, UITextViewDelegate {
    ...
    var rentingBeingRated: Renting? = Renting(id: "1", inseratID: "-L2GGCQf0M-9rPzx3Wx4", userID: "W7VPwDFSTyNwW0WJl38MhsVmcdX2", startDate: Date(), endDate: Date(), confirmationStatus: true, rentingPrice: 10.5) // TODO: set from profile, only here for testing
