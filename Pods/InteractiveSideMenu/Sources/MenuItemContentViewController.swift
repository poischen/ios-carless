...
extension SideMenuItemContent where Self: UIViewController {
    ...
    public func showSideMenu() {
        ...
        let profileViewController = profileStoryboard.instantiateViewController(withIdentifier: "HomePage") as! MenuContainerViewController
        profileViewController.showSideMenu()
